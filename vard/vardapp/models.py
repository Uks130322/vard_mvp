...
class Access(models.Model):
    ...
    user_id = models.ForeignKey('User', on_delete=models.CASCADE, null=False, verbose_name='user id',related_name='invited_user')
    ...
    owner_id = models.ForeignKey('User', on_delete=models.CASCADE, null=False, verbose_name='owner id',related_name='owner')
