# Generated by Django 4.2.11 on 2024-03-21 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chart_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vardapp.chart', verbose_name='chart id')),
            ],
        ),
        migrations.CreateModel(
            name='ReadComment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.IntegerField(choices=[(1, 'Csv'), (2, 'Json'), (3, 'Excel'), (4, 'Pdf')], verbose_name='id type of file')),
                ('date_creation', models.DateTimeField(auto_now_add=True, verbose_name='date of creation')),
                ('date_change', models.DateTimeField(auto_now=True, verbose_name='date of change')),
        ...
        migrations.AddField(
            model_name='comment',
            name='dashboard_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vardapp.dashboard', verbose_name='dashboard id'),
        ),
        migrations.AddField(
            model_name='comment',
            name='file_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vardapp.file', verbose_name='cells id'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user_id',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vardapp.file', verbose_name='')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user id')),
            ],
        ),
    ]
