    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vardapp.chart')),
            ],
        ),
        migrations.AddField(
            model_name='chart',
            name='clientdb_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vardapp.clientdb', verbose_name='clientdb id'),
        ),
        migrations.AddField(
            model_name='chart',
            name='user_id',
